...
class DashboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($role === "Guru Mapel") {
            return $this->guruMapel($request);
        }

        // fallback (sesuaikan: bisa redirect / view lain)
    ...
    {
        return [
            'rate' => 0, 'rate_prev' => 0, 'rate_delta' => 0,
            'alpha' => 0, 'alpha_prev' => 0, 'alpha_delta' => 0,
            'rawan_count' => 0,
        ];
    }
    ...
    {
        return [
            'avg' => 0, 'avg_prev' => 0, 'avg_delta' => 0,
            'below_kkm' => 0, 'below_kkm_prev' => 0,
            'unggul' => 0, 'unggul_prev' => 0,
        ];
    }
