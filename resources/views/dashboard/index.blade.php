                ...
                <div class="row">
                  ...
                  <div class="col-sm-6 text-center">
                    <div class="img-welcome-banner">
                      <img src="/build/images/widget/welcome-banner.png" alt="img" class="img-fluid" />
                    </div>
                  </div>
                </div>
              </div>
...
@section('scripts')
    ...
    <script src="/build/js/widgets/all-earnings-graph.js"></script>
    <script src="/build/js/widgets/page-views-graph.js"></script>
    <script src="/build/js/widgets/total-task-graph.js"></script>
    <script src="/build/js/widgets/download-graph.js"></script>
    <script src="/build/js/widgets/customer-rate-graph.js"></script>
    <script src="/build/js/widgets/tasks-graph.js"></script>
    <script src="/build/js/widgets/total-income-graph.js"></script>
