                        ...
                        <div class="card-body">
                            <div class="d-flex">
                                ...
                                <div class="flex-shrink-0">
                                    <img src="/build/images/widget/img-card-master.svg" alt="img" class="img-fluid" />
                                </div>
                            </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6 col-xxl-3">
                            <div class="card shadow-none border mb-0">
                                <div class="card-body p-3">
                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                        <img src="/build/images/widget/img-food.png" alt="img" class="img-fluid" />
                                        <div class="dropdown">
                        ...
                        <div class="col-md-6 col-xxl-3">
                            <div class="card shadow-none border mb-0">
                                <div class="card-body p-3">
                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                        <img src="/build/images/widget/img-travel.png" alt="img"
                                            class="img-fluid" />
                                        <div class="dropdown">
                                            <a class="avtar avtar-xs btn-link-secondary dropdown-toggle arrow-none"
                                                href="#" data-bs-toggle="dropdown" aria-haspopup="true"
                        ...
                        <div class="col-md-6 col-xxl-3">
                            <div class="card shadow-none border mb-0">
                                <div class="card-body p-3">
                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                        <img src="/build/images/widget/img-shoping.png" alt="img"
                                            class="img-fluid" />
                                        <div class="dropdown">
                                            <a class="avtar avtar-xs btn-link-secondary dropdown-toggle arrow-none"
                                                href="#" data-bs-toggle="dropdown" aria-haspopup="true"
                        ...
                        <div class="col-md-6 col-xxl-3">
                            <div class="card shadow-none border mb-0">
                                <div class="card-body p-3">
                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                        <img src="/build/images/widget/img-helth.png" alt="img" class="img-fluid" />
                                        <div class="dropdown">
                                            <a class="avtar avtar-xs btn-link-secondary dropdown-toggle arrow-none"
                                                href="#" data-bs-toggle="dropdown" aria-haspopup="true"
                                                aria-expanded="false">
                        ...
                        <div class="col-12">
                            <div class="card shadow-none border mb-0">
                                <div class="card-body p-3">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="/build/images/widget/img-card-1.png" alt="img"
                                                class="img-fluid" />
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <div
                        ...
                        <div class="col-12">
                            <div class="card shadow-none border mb-0">
                                <div class="card-body p-3">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="/build/images/widget/img-card-2.png" alt="img"
                                                class="img-fluid" />
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <div
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center justify-content-between gap-2 my-3">
                        ...
                        <a href="#" class="avtar"><img class="rounded-circle img-fluid"
                                src="/build/images/user/avatar-1.jpg" alt="User image" /></a>
                        <a href="#" class="avtar"><img class="rounded-circle img-fluid"
                                src="/build/images/user/avatar-2.jpg" alt="User image" /></a>
                        <a href="#" class="avtar"><img class="rounded-circle img-fluid"
                                src="/build/images/user/avatar-3.jpg" alt="User image" /></a>
                        <a href="#" class="avtar"><img class="rounded-circle img-fluid"
                                src="/build/images/user/avatar-4.jpg" alt="User image" /></a>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item px-0">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="/build/images/widget/img-acitivity-3.svg" alt="img"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="/build/images/user/avatar-2.jpg" alt="user image"
                                                    class="img-radius wid-40" />
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="/build/images/user/avatar-3.jpg" alt="user image"
                                                    class="img-radius wid-40" />
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="/build/images/user/avatar-4.jpg" alt="user image"
                                                    class="img-radius wid-40" />
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="/build/images/user/avatar-5.jpg" alt="user image"
                                                    class="img-radius wid-40" />
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h6 class="mb-0">Airi Satou</h6>
...
@section('scripts')
    ...
    <!-- custom widgets js -->
    <script src="/build/js/widgets/total-line-1-chart.js"></script>
    <script src="/build/js/widgets/total-line-2-chart.js"></script>
    <script src="/build/js/widgets/total-line-3-chart.js"></script>
    <script src="/build/js/widgets/cashflow-bar-chart.js"></script>
    <script src="/build/js/widgets/category-donut-chart.js"></script>
