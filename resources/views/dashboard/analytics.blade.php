                  ...
                  <ul class="list-group list-group-flush border-top-0">
                    <li class="list-group-item">
                      <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                          <div class="avtar avtar-s bg-light-secondary">
                            <img src="/build/images/widget/img-paypal.png" alt="img" class="img-fluid" />
                          </div>
                        </div>
                    ...
                    <li class="list-group-item">
                      <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                          <div class="avtar avtar-s bg-light-secondary">
                            <img src="/build/images/widget/img-gpay.png" alt="img" class="img-fluid" />
                          </div>
                        </div>
                        <div class="flex-grow-1 mx-2">
                          <p class="mb-1">Gpay</p>
                    ...
                    <li class="list-group-item">
                      <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                          <div class="avtar avtar-s bg-light-secondary">
                            <img src="/build/images/widget/img-phonepay.png" alt="img" class="img-fluid" />
                          </div>
                        </div>
                        <div class="flex-grow-1 mx-2">
