            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="my-3">
                        ...
                        <h5 class="text-center mt-3">$30200 <small class="text-primary"><i class="ti ti-arrow-up-right"></i>
                                30.6%</small></h5>
                    </div>
                    <div class="d-grid">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="my-3">
                        ...
                        <h5 class="text-center mt-3">$30200 <small class="text-success"><i class="ti ti-arrow-up-right"></i>
                                30.6%</small></h5>
                    </div>
                    <div class="d-grid">
                        <a class="btn btn-link-primary" role="button" href="#">View More</a>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="my-3">
                        ...
                        <h5 class="text-center mt-3">$30200 <small class="text-danger"><i
                                    class="ti ti-arrow-down-right"></i> 30.6%</small></h5>
                    </div>
                    <div class="d-grid">
                        <a class="btn btn-link-primary" role="button" href="#">View More</a>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="progress mt-2 bg-transparent" style="height: 8px">
                        ...
                        <div class="progress-bar bg-warning" role="progressbar" style="width: 20%" aria-valuenow="30"
                            aria-valuemin="0" aria-valuemax="100"></div>
                        <div class="progress-bar bg-light-primary" role="progressbar" style="width: 20%" aria-valuenow="30"
                            aria-valuemin="0" aria-valuemax="100"></div>
                        <div class="progress-bar bg-success" role="progressbar" style="width: 25%" aria-valuenow="20"
                            aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h6 class="mb-0">Update version <span class="badge bg-light-success">V1.1.0</span>
                                    </h6>
                                </div>
                            </div>
                            <div class="mt-2 mb-3">
                        ...
                        <ul class="list-group list-group-flush border-top-0">
                            <li class="list-group-item">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="avtar avtar-s bg-light-secondary">
                                            <img src="/build/images/widget/img-paypal.png" alt="img"
                                                class="img-fluid" />
                                        </div>
                                    </div>
                            ...
                            <li class="list-group-item">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="avtar avtar-s bg-light-secondary">
                                            <img src="/build/images/widget/img-gpay.png" alt="img"
                                                class="img-fluid" />
                                        </div>
                                    </div>
                                    <div class="flex-grow-1 mx-2">
                            ...
                            <li class="list-group-item">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="avtar avtar-s bg-light-secondary">
                                            <img src="/build/images/widget/img-phonepay.png" alt="img"
                                                class="img-fluid" />
                                        </div>
                                    </div>
                                    <div class="flex-grow-1 mx-2">
...
@section('scripts')
    ...
    <!-- custom widget js -->
    <script src="/build/js/widgets/new-orders-graph.js"></script>
    <script src="/build/js/widgets/new-users-graph.js"></script>
    <script src="/build/js/widgets/visitors-graph.js"></script>
    <script src="/build/js/widgets/overview-chart.js"></script>
    <script src="/build/js/widgets/income-graph.js"></script>
    <script src="/build/js/widgets/languages-graph.js"></script>
    <script src="/build/js/widgets/overview-product-graph.js"></script>
    <script src="/build/js/widgets/total-earning-graph-1.js"></script>
    <script src="/build/js/widgets/total-earning-graph-2.js"></script>
