...
@section('content')
    ...
    <x-breadcrumb item="Charts" active="Apex Charts" />

    <!-- [ Main Content ] start -->
    <div class="row">
        <!-- prettier-ignore -->
          <x-link title="ApexCharts" text="ApexCharts is a modern charting library that helps developers to create beautiful and interactive visualizations for web pages." link="https://apexcharts.com/"/>
    </div>
    <div class="row">
        <!-- [ variant-chart ] start -->
        <div class="col-md-6">
