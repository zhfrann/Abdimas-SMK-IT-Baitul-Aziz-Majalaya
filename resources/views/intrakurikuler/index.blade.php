            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <button
                    type="button"
                    class="btn btn-sm btn-light-warning mb-1"
                    data-bs-toggle="modal"
                    data-bs-target="#modalIntra"
                    data-mode="edit"
                ...
                <td>
                  ...
                  <a href="{{ route('assesment-sumatif.index', $item->intrakurikuler_id) }}" class="btn btn-sm btn-light-primary mb-1">Asesmen Sumatif</a>
                </td>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <form id="intraForm" method="POST" action="{{ route('intrakurikuler.store') }}">
        ...
        <input type="hidden" name="_modal_mode" id="intra_modal_mode" value="{{ old('_modal_mode', 'create') }}">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="nama_pelajaran" id="intra_nama"
