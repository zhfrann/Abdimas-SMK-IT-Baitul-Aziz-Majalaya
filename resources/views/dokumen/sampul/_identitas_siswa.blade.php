<style>
    .page.identitas-siswa {
        margin: 18mm 14mm 18mm;
    }

    .page.identitas-siswa .title {
        /* margin-top: 18mm !important; */
    }

    .page.identitas-siswa .student-data {
...
<div class="page identitas-siswa">
    <div class="title" style="text-align:center; font-weight:bold; font-size:15pt; margin-top:18mm;">
        IDENTITAS PESERTA DIDIK
    </div>
    <table class="student-data" style="margin:30px auto 0 auto; font-size:13pt;">
        <tr>
