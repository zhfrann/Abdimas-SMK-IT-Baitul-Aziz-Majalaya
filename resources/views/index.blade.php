...
<html lang="en">
  <head>
    ...
    <link href="/build/css/plugins/animate.min.css" rel="stylesheet" type="text/css" />
    ...
    <link rel="stylesheet" href="/build/fonts/tabler-icons.min.css" />
    <!-- [Feather Icons] https://feathericons.com -->
    <link rel="stylesheet" href="/build/fonts/feather.css" />
    <!-- [Font Awesome Icons] https://fontawesome.com/icons -->
    <link rel="stylesheet" href="/build/fonts/fontawesome.css" />
    <!-- [Material Icons] https://fonts.google.com/icons -->
    <link rel="stylesheet" href="/build/fonts/material.css" />
    <!-- [Template CSS Files] -->
    <link rel="stylesheet" href="/build/css/style.css" id="main-style-link" />
    <link rel="stylesheet" href="/build/css/style-preset.css" />
    <script src="/build/js/tech-stack.js"></script>
  ...
  >
    ...
    <!-- [ Header ] start -->
    <header id="home" style="background-image: url(/build/images/landing/img-headerbg.jpg)">
      <!-- [ Nav ] start -->
      <!-- [ Nav ] start -->
      <nav class="navbar navbar-expand-md navbar-light default">
        <div class="container">
          <a class="navbar-brand" href="/index">
            <img src="/build/images/logo-dark.svg" alt="logo" />
          </a>
          <button
        ...
        <div class="row justify-content-center">
          <div class="col-md-10 text-center">
            ...
            <div class="my-4 my-sm-5 wow fadeInUp" data-wow-delay="0.4s">
              <a href="/elements/bc_alert" class="btn btn-outline-secondary me-2">Explore Components</a>
              <a href="/dashboard/index" class="btn btn-primary">Live Preview</a>
            </div>
      ...
      <div class="technology-block">
        <ul class="list-inline mb-0">
          <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Click to Preview Bootstrap 5">
            <a href="#"><img src="/build/images/landing/tech-bootstrap.svg" alt="img" class="img-fluid" /></a>
          </li>
          <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Click to Preview React MUI">
            <a href="https://ableproadmin.com/react/" target="_blank"
              ><img src="/build/images/landing/tech-react.svg" alt="img" class="img-fluid"
            /></a>
          </li>
          <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Click to Preview Angular Material UI">
            <a href="https://ableproadmin.com/angular/default/" target="_blank"
              ><img src="/build/images/landing/tech-angular.svg" alt="img" class="img-fluid"
            /></a>
          </li>
          <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Click to Preview CodeIgniter">
            <a href="https://ableproadmin.com/codeigniter/default/public/" target="_blank"
              ><img src="/build/images/landing/tech-codeigniter.svg" alt="img" class="img-fluid"
            /></a>
          </li>
          <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Click to Preview ASP.net">
            <a href="https://able-pro.azurewebsites.net/" target="_blank"
              ><img src="/build/images/landing/tech-net.svg" alt="img" class="img-fluid"
            /></a>
          </li>
          <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Figma Design System">
            <a
              ...
              target="_blank"
              ><img src="/build/images/landing/tech-figma.svg" alt="img" class="img-fluid"
            /></a>
          </li>
          <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Click to Preview Next js">
            <a href="https://able-pro-material-next-ts-navy.vercel.app/"
              ><img src="/build/images/landing/tech-nextjs.svg" alt="img" class="img-fluid"
            /></a>
          </li>
          <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Click to Preview Vue">
            <a href="https://ableproadmin.com/vue/"><img src="/build/images/landing/tech-vuetify.svg" alt="img" class="img-fluid" /></a>
          </li>
        </ul>
      </div>
    </header>
      ...
      <div class="container technology-block">
        ...
        <div class="row align-items-center justify-content-start mb-4 mb-sm-2">
          <div class="col-md-6 col-lg-4">
            <div class="card">
              <div class="card-body">
                <img src="/build/images/landing/tech-bootstrap.svg" alt="img" class="img-fluid" />
                <h4 class="mb-3 mt-2">Bootstrap 5</h4>
                <p class="text-muted"
                  >Able Pro - Boost your project's visual appeal and functionality with our Bootstrap 5 dashboard template.</p
                >
                <a class="btn btn-light-dark mt-2" href="/dashboard/index" target="_blank"
          ...
          <div class="col-md-6 col-lg-4">
            <div class="card">
              <div class="card-body">
                <img src="/build/images/landing/tech-react-1.svg" alt="img" class="img-fluid" />
                <h4 class="mb-3 mt-2">React Material-UI</h4>
                <p class="text-muted"
                  >Able Pro React dashboard template is a powerful tool that utilizes the Material-UI component library to create stunning
                  and intuitive user interfaces.</p
                >
                <a class="btn btn-light-dark mt-2" href="https://ableproadmin.com/react" target="_blank"
          ...
          <div class="col-md-6 col-lg-4">
            <div class="card">
              <div class="card-body">
                ...
                <p class="text-muted"
                  >Able Pro .NET version is a robust dashboard template designed specifically for .NET developers. Its comes with a wide
                  range of pre-built components.</p
                >
                <a class="btn btn-light-dark mt-2" href="https://able-pro.azurewebsites.net/" target="_blank"
          ...
          <div class="col-md-6 col-lg-4">
            <div class="card">
              <div class="card-body">
                ...
                <p class="text-muted"
                  >Able Pro CodeIgniter version is a powerful dashboard template built specifically for developers who use the CodeIgniter
                  PHP framework.
                </p>
                <a class="btn btn-light-dark mt-2" href="https://ableproadmin.com/codeigniter/default/public/" target="_blank"
          ...
          <div class="col-md-6 col-lg-4">
            <div class="card">
              <div class="card-body">
                <img src="/build/images/landing/tech-angular.svg" alt="img" class="img-fluid" />
                <h4 class="mb-3 mt-2">Angular Material-UI</h4>
                <p class="text-muted"
                  >Able Pro Angular dashboard template is a powerful tool that utilizes the Material-UI component library to create stunning
                  and intuitive user interfaces.</p
                >
                <a class="btn btn-light-dark mt-2" href="https://ableproadmin.com/angular/default/" target="_blank"
          ...
          <div class="col-md-6 col-lg-4">
            <div class="card">
              <div class="card-body">
                ...
                <p class="text-muted"
                  >Able Pro comes with a Figma design file that allows you to customize and fine-tune your dashboard to meet your specific
                  needs.</p
                >
          ...
          <div class="col-md-6 col-lg-4">
            <div class="card">
              <div class="card-body">
                <img src="/build/images/landing/tech-nextjs.svg" alt="img" class="img-fluid" />
                <h4 class="mb-3 mt-2">Next Js</h4>
                <p class="text-muted"
                  >Able Pro Next Js dashboard template is a powerful tool that utilizes the Material-UI component library to create stunning
                  and intuitive user interfaces.</p
                >
                <a class="btn btn-light-dark mt-2" href="https://able-pro-material-next-ts-navy.vercel.app/" target="_blank"
                  ><i class="ti ti-external-link"></i> Preview Next Js</a
                >
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-4">
            <div class="card">
              <div class="card-body">
                <img src="/build/images/landing/tech-vuetify.svg" alt="img" class="img-fluid" />
                <h4 class="mb-3 mt-2">vue</h4>
                <p class="text-muted">Able Pro - Boost your project's visual appeal and functionality with our Vue Dashboard template.</p>
                <a class="btn btn-light-dark mt-2" href="https://ableproadmin.com/vue/" target="_blank"
          ...
          <div class="col-md-6 col-lg-4">
            <div class="card">
              <div class="card-body mt-2">
                ...
                <p class="text-muted"> Check the live preview of Able Pro Figma design file. Figma file included in all licenses. </p>
                <img class="pt-2" src="/build/images/landing/feature-figma.png" width="100%" />
                <a
          ...
          <div class="col-md-6 col-lg-4">
            <div class="card">
              <div class="card-body mt-2">
                ...
                <p class="text-muted"> Access all components of Able Pro in one place to make your development work easier. </p>
                <img class="pt-2" src="/build/images/landing/feature-components.png" width="100%" />
                <a class="btn btn-light-dark mt-3" href="/elements/bc_alert" target="_blank"
          ...
          <div class="col-md-6 col-lg-4">
            <div class="card">
              <div class="card-body mt-2">
                ...
                <img class="pt-2" src="/build/images/landing/feature-documentation.png" width="100%" />
                <a class="btn btn-light-dark mt-3" href="https://phoenixcoded.gitbook.io/able-pro/" target="_blank"
          ...
          <div class="col-md-6 position-relative wow fadeInRight" data-wow-delay="0.4s">
            <div class="owl-carousel owl-theme screen-slide img-app-moke">
              <div class="item" data-hash="app_1">
                <img src="/build/images/landing/chat.png" alt="img" class="img-fluid rounded" />
              </div>
              <div class="item" data-hash="app_2">
                <img src="/build/images/landing/e-commerce.png" alt="img" class="img-fluid rounded" />
              </div>
              <div class="item" data-hash="app_3">
                <img src="/build/images/landing/mail.png" alt="img" class="img-fluid rounded" />
              </div>
              <div class="item" data-hash="app_4">
                <img src="/build/images/landing/social.png" alt="img" class="img-fluid rounded" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container title mb-0">
        <div class="row align-items-center wow fadeInUp" data-wow-delay="0.2s">
          <div class="col-md-8">
            ...
            <p class="text-muted mb-md-0"> Download the Free MIT Able Pro Dashboard Template before make your purchase decision. </p>
          </div>
          <div class="col-md-4 text-md-end">
            <a class="btn btn-lg btn-outline-secondary bg-gray-100 m-1" href="/dashboard/index" target="_blank"
    ...
    <section class="support-team-block">
      <div class="container title">
        <div class="row justify-content-center text-center wow fadeInUp" data-wow-delay="0.2s">
          <div class="col-md-8 col-xl-6">
            <h2 class="mb-3"> They <span class="text-primary">love</span> Able Pro, Now your turn 😍 </h2>
            <!-- prettier-ignore -->
            <p class="mb-0">We take pride in our Dashboard development, which has been consistently rated 4.6/5 by our
            satisfied customers. It brings us joy to share the positive feedback we have received from our loyal
            clients.</p>
          </div>
        </div>
      </div>
                    ...
                    <div class="card-body">
                      <div class="d-flex">
                        <div class="flex-shrink-0">
                          <img src="/build/images/user/avatar-1.jpg" alt="user-image" class="rounded-circle wid-60 hei-60" />
                        </div>
                        <div class="flex-grow-1 ms-3">
                          <p class="mb-1"> “Amazing template for fast develop.💎“ </p>
                          <small>devbar - <span class="text-muted">Customizability</span></small>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <li class="list-inline-item">
                  <div class="card support-card">
                    <div class="card-body">
                      <div class="d-flex">
                        <div class="flex-shrink-0">
                          <img src="/build/images/user/avatar-2.jpg" alt="user-image" class="rounded-circle wid-60 hei-60" />
                        </div>
                        <div class="flex-grow-1 ms-3">
                          <!-- prettier-ignore -->
                ...
                <li class="list-inline-item">
                  <div class="card support-card">
                    <div class="card-body">
                      <div class="d-flex">
                        <div class="flex-shrink-0">
                          <img src="/build/images/user/avatar-3.jpg" alt="user-image" class="rounded-circle wid-60 hei-60" />
                        </div>
                        <div class="flex-grow-1 ms-3">
                          <p class="mb-1"> “This has been one of my favorite admin dashboards to use. 😍“ </p>
                          <small>htmhell - <span class="text-muted">Design Quality</span></small>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <li class="list-inline-item">
                  <div class="card support-card">
                    <div class="card-body">
                      <div class="d-flex">
                        <div class="flex-shrink-0">
                          <img src="/build/images/user/avatar-4.jpg" alt="user-image" class="rounded-circle wid-60 hei-60" />
                        </div>
                        <div class="flex-grow-1 ms-3">
                          <!-- prettier-ignore -->
                          <p class="mb-1">“Excellent support, if we need any modification, they are doing immediately“</p>
                          <small>hemchandkodali - <span class="text-muted">Customer Support</span></small>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <li class="list-inline-item">
                  <div class="card support-card">
                    <div class="card-body">
                      <div class="d-flex">
                        <div class="flex-shrink-0">
                          <img src="/build/images/user/avatar-5.jpg" alt="user-image" class="rounded-circle wid-60 hei-60" />
                        </div>
                        <div class="flex-grow-1 ms-3">
                          <p class="mb-1"> “For developers like me, this is the total package! 😍 “ </p>
                          <small>sumaranjum - <span class="text-muted">Feature Availability</span></small>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card support-card">
                    <div class="card-body">
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-3">
                          <!-- prettier-ignore -->
                          <p class="mb-1">“I love the looks of Able Pro 7.0. I really like the colors you guys have chosen
                          for this theme. It looks really nice.. 💎“</p>
                    ...
                    <div class="card-body">
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-3">
                          ...
                          <small>Genstiade - <span class="text-muted">Feature Availability</span></small>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card support-card">
                    <div class="card-body">
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-3">
                          <!-- prettier-ignore -->
                          <p class="mb-1">“I have it running on a medium size site that is geared towards displaying stats
                          tables and custom forms, a blog and a forum. My customers love the design and the speed in
                          which the pages load. 😍 “</p>
                          <small>RizzoFrank - <span class="text-muted">Design Quality</span></small>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card support-card">
                    <div class="card-body">
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-3">
                          <p class="mb-1"> “Perfect for my need. Elegant look n feel with blazing fast code. 💎“ </p>
                          <small>ThemeShakers - <span class="text-muted">Feature Availability</span></small>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card support-card">
                    <div class="card-body">
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-3">
                          <!-- prettier-ignore -->
                          <p class="mb-1">“Excellent template! It's also very well organized and easy to find our way..“
                        </p>
                          <small>Danlec - <span class="text-muted">Code Quality</span></small>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card support-card">
                    <div class="card-body">
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-3">
                          <!-- prettier-ignore -->
                          <p class="mb-1">“Their Team is great and working great always. when you need help...“</p>
                          <small>manojkumarhr - <span class="text-muted">Customer Support</span></small>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card support-card">
                    <div class="card-body">
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-3">
                          <p class="mb-1"> “Wonderful theme, full of features, with ton of addons.“ </p>
                          <small>momennoor - <span class="text-muted">Design Quality</span></small>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card support-card">
                    <div class="card-body">
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-3">
                          <p class="mb-1"> “An excellent theme. It contains everything you need to open complex projects. 😍 “ </p>
                          <small>Vihtora - <span class="text-muted">Other</span></small>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card support-card">
                    <div class="card-body">
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-3">
                          <p class="mb-1"> “Excellent template. Very complete. 💎“ </p>
                          <small>mundodascasas - <span class="text-muted">Code Quality</span></small>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card support-card">
                    <div class="card-body">
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-3">
                          <p class="mb-1"
                            >“It serves my all purposes well and one thing it was great because i didn't require designer at all.“</p
                          >
                          <small>amit1134 - <span class="text-muted">Code Quality</span></small>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card support-card">
                    <div class="card-body">
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-3">
                          <!-- prettier-ignore -->
                          <p class="mb-1">“I highly recommend Able pro admin template and team phoenixcoded item. It was best purchase on themeforest for me.“</p>
                          <small>vishalmg - <span class="text-muted">Flexibility</span></small>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card support-card">
                    <div class="card-body">
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-3">
                          <!-- prettier-ignore -->
                          <p class="mb-1">“5 stars are for the excellent support, that is brilliant! The design is very
                          cool and...!“</p>
                          <small>ab69aho - <span class="text-muted">Code Quality</span></small>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div class="col-md-12">
            ...
            <div class="row justify-content-center client-block g-5">
              <div class="col-auto wow fadeInRight" data-wow-delay="0.4s">
                <img src="/build/images/landing/client-eagames.svg" alt="img" class="img-fluid" />
              </div>
              <div class="col-auto wow fadeInRight" data-wow-delay="0.4s">
                <img src="/build/images/landing/client-vodafone.svg" alt="img" class="img-fluid" />
              </div>
              <div class="col-auto wow fadeInRight" data-wow-delay="0.4s">
                <img src="/build/images/landing/client-crystal-1.svg" alt="img" class="img-fluid" />
              </div>
              <div class="col-auto wow fadeInRight" data-wow-delay="0.5s">
                <img src="/build/images/landing/client-haswent-2.svg" alt="img" class="img-fluid" />
              </div>
              <div class="col-auto wow fadeInRight" data-wow-delay="0.6s">
                <img src="/build/images/landing/client-haxter-3.svg" alt="img" class="img-fluid" />
              </div>
              <div class="col-auto wow fadeInRight" data-wow-delay="0.7s">
                <img src="/build/images/landing/client-montecito-4.svg" alt="img" class="img-fluid" />
              </div>
              <div class="col-auto wow fadeInRight" data-wow-delay="0.8s">
                <img src="/build/images/landing/client-slingshot.svg" alt="img" class="img-fluid" />
              </div>
              <div class="col-auto wow fadeInRight" data-wow-delay="0.9s">
                <img src="/build/images/landing/client-totalstudio-5.svg" alt="img" class="img-fluid" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
              <img src="/build/images/logo-dark.svg" alt="image" class="img-fluid mb-3" />
              <p class="mb-4">
    ...
    <script src="/build/js/plugins/wow.min.js"></script>
    <script src="https://cdn.jsdelivr.net/jquery.marquee/1.4.0/jquery.marquee.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/owl.carousel.min.js"></script>
    <script src="/build/js/plugins/Jarallax.js"></script>
    <script>
                ...
                <div class="col-6">
                  <div class="d-grid">
                    <button
                      ...
                      title="Caption Show"
                    >
                      <img src="/build/images/customizer/caption-on.svg" alt="img" class="img-fluid" />
                    </button>
                  </div>
                </div>
                <div class="col-6">
                  <div class="d-grid">
                    <button
                      ...
                      title="Caption Hide"
                    >
                      <img src="/build/images/customizer/caption-off.svg" alt="img" class="img-fluid" />
                    </button>
                  </div>
                </div>
              </div>
                  ...
                  <div class="col-6">
                    <div class="d-grid">
                      <button
                        ...
                        title="LTR"
                      >
                        <img src="/build/images/customizer/ltr.svg" alt="img" class="img-fluid" />
                      </button>
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="d-grid">
                      <button
                        ...
                        title="RTL"
                      >
                        <img src="/build/images/customizer/rtl.svg" alt="img" class="img-fluid" />
                      </button>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-6">
                    <div class="d-grid">
                      <button
                        ...
                        title="Full Width"
                      >
                        <img src="/build/images/customizer/full.svg" alt="img" class="img-fluid" />
                      </button>
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="d-grid">
                      <button
                        ...
                        title="Fixed Width"
                      >
                        <img src="/build/images/customizer/fixed.svg" alt="img" class="img-fluid" />
                      </button>
                    </div>
                  </div>
                </div>
