              ...
              <div class="card h-100">
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    {{-- SAS 1 --}}
                    <div class="mb-4 col-md-6">
                      <label class="form-label fs-6 f-w-600">SAS 1</label>
                      <p class="mb-2 text-muted">Ulangan akhir semester bab 1–2</p>
                      <input type="number" class="form-control" placeholder="Nilai (0-100)" value="80">
                    </div>

                    {{-- SAS 2 --}}
                    <div class="mb-4 col-md-6">
                      <label class="form-label fs-6 f-w-600">SAS 2</label>
                      <p class="mb-2 text-muted">Proyek/Praktik akhir semester</p>
                      <input type="number" class="form-control" placeholder="Nilai (0-100)" value="84">
                    </div>

                    {{-- SAS 3 (opsional contoh tambahan) --}}
                    <div class="mb-4 col-md-6">
                      <label class="form-label fs-6 f-w-600">SAS 3</label>
                      <p class="mb-2 text-muted">Portofolio / Tugas terstruktur</p>
                      <input type="number" class="form-control" placeholder="Nilai (0-100)" value="82">
                    </div>

                    {{-- SAS 4 (opsional contoh tambahan) --}}
                    <div class="mb-4 col-md-6">
                      <label class="form-label fs-6 f-w-600">SAS 4</label>
                      <p class="mb-2 text-muted">Penilaian praktik/performansi</p>
                      <input type="number" class="form-control" placeholder="Nilai (0-100)" value="81">
                    </div>
              ...
              <div class="card">
                <div class="card-body d-flex flex-wrap align-items-center justify-content-between gap-3">
                  ...
                  <div class="d-flex align-items-center gap-2">
                    ...
                    <a href="/components/asesment_sumatif" class="btn btn-light-secondary">Kembali</a>
                  </div>
