      ...
      <div class="technology-block">
        <ul class="list-inline mb-0">
          <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Click to Preview Bootstrap 5">
            <a href="/dashboard/index" target="_blank"
          ...
          <div class="col-md-6 col-lg-4">
            <div class="card">
              <div class="card-body mt-2">
                ...
                <img class="pt-2" alt="image" src="/build/images/landing/feature-figma.png" width="100%" />
                <a
          ...
          <div class="col-md-6 col-lg-4">
            <div class="card">
              <div class="card-body mt-2">
                ...
                <img class="pt-2" alt="image" src="/build/images/landing/feature-components.png" width="100%" />
          ...
          <div class="col-md-6 col-lg-4">
            <div class="card">
              <div class="card-body mt-2">
                ...
                <img class="pt-2" alt="image" src="/build/images/landing/feature-documentation.png" width="100%" />
            ...
            <div class="workspace-slider-block rounded wow fadeInUp bg-gray-800" data-wow-delay="0.2s">
              <div class="workspace-slider owl-carousel owl-theme">
                <div class="item" data-hash="workspace_1"
                  ><img src="/build/images/landing/img-slider.jpg" width="60%" alt="img" class="img-fluid img-ws-slider rounded"
                /></div>
            ...
            <div class="row">
              <div class="col-6">
                <div class="jarallax h-1001" data-jarallax-element="-100">
                  <img src=" /build/images/landing/img-productivity-1.png" alt="image" class="img-fluid jarallax-img" />
                </div>
              </div>
              <div class="col-6">
                <div class="jarallax h-1001" data-jarallax-element="100">
                  <img src="/build/images/landing/img-productivity-2.png" alt="image" class="img-fluid jarallax-img" />
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="container title mb-0">
        <div class="row align-items-center">
          <div class="col-md-6 position-relative wow fadeInLeft" data-wow-delay="0.2s">
            <img src="/build/images/landing/img-dashboard-suggestion.png" alt="img" class="img-fluid img-suggest-moke" />
          </div>
          <div class="col-md-6 wow fadeInUp" data-wow-delay="0.2s">
