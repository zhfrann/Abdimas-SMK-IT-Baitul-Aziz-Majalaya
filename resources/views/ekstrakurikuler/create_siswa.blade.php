        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5>Tambah Siswa ke Ekstrakurikuler: {{ $ekskul->nama_pelajaran }} ({{ $ekskul->tahunAjaran->tahun }}
                        {{ $ekskul->tahunAjaran->semester }})</h5>
                </div>

                <div class="card-body">
                    <form method="POST"
                        action="{{ route('ekstrakurikuler.manage-siswa.store', $ekskul->ekstrakurikuler_id) }}">
                        @csrf
                        ...
                        <div class="d-flex gap-2 mt-3">
                            ...
                            <a href="{{ route('ekstrakurikuler.manage-siswa.index', $ekskul->ekstrakurikuler_id) }}"
